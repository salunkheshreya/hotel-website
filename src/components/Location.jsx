            ...
            <div className="room-content-flex">
                <div className="room-main-content">
                    <div className="room-images-grid">
                        <img src={'/assets/rooms/room1.jpeg'} alt="Standard Room main" className="room-img-main" />
                        <img src={'/assets/rooms/room2.jpeg'} alt="Standard Room view 2" />
                        <img src={'/assets/rooms/room3.jpeg'} alt="Standard Room view 3" />
                    </div>
                ...
                <div className="room-sidebar">
                    <div className="booking-card">
                        <h2>1 Standard Bed</h2>
                        <div className="bed-info">Fits 2 Adults</div>
                        ...
                        <div className="price-section">
                            ...
                            <h3 className="price-value">&#8377;3200</h3>
                            <span className="price-taxes">+760 taxes & Fees</span>
                        </div>

                        <Link to="/booking" state={{ hotelName, location: hotelLocation, roomType: 'Standard Room', price: 3200 }} className="btn-book-primary">
                            Book this now
                        </Link>
                    </div>
                    ...
                    <div className="room-types-card">
                        ...
                        <div className="room-type-option">
                            ...
                            <div className="room-type-action">
                                <div className="room-type-price">&#8377;3200</div>
                        ...
                        <div className="room-type-option">
                            ...
                            <div className="room-type-action">
                                <div className="room-type-price">&#8377;4500</div>
