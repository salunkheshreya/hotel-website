...
const FamilyRoom = ()=>{
        ...
        return (
            <div  style={{marginBottom:300,margin:0,padding:0,boxSizing:"border-box",height:1150,position:"relative",overflow:"hidden"}}>
                <div className="mx-5">
                   <h1 style={{fontFamily:"Times New Roman",fontWeight:"bold"}}>Family Room</h1>
                   <div style={{position:"relative",bottom:9,fontSize:25}}>
                   <IoStarSharp />
                   <IoStarSharp />
                   <IoStarSharp />
                   <IoStarSharp />
                   </div> <button  className="btn btn-outline-success float-end " style={{position:'relative',bottom:80,right:90,width:70}} onClick={handleBackClick}>Back</button>
                  
                   <hr></hr>
                     <div className="border rounded w-50 p-3" style={{height:950}}>
                        <div>
                           <img className="p-3 rounded-5" style={{position:"relative",bottom:20}} 
                            src={'/assets/rooms/famroom2.jpg'}
                            alt="room1" height={355} width={290} />
                           <img className=" rounded-5 d-inline" style={{position:"relative",bottom:-60,left:10}} height={150} width={250} src={'/assets/rooms/famroom1.jpg'} alt="room2"/>
                           <img className="rounded-5" style={{position:"relative",left:200,bottom:360,left:300}} height={150} width={250} src={'/assets/rooms/famroom2.jpg'} alt="room3"/>
                ...
                <div className="border float-end me-4 rounded p-1" style={{position:"relative",bottom:950,right:28,width:550,fontFamily:"sans-serif,georgia"}} >
                    <h1 style={{fontFamily:'Sans-Serif Verdana',fontWeight:'bold'}}>5 Standard Bed with Balcony</h1>
                    <h3 className="p-2">Fits 10 Adults</h3>
                    ...
                    <text className="d-block p-0" style={{fontSize:18}}>Price per night:</text>
                    <h1 className=" d-inline-block text-primary ms-4 p-1">&#8377;8000</h1><text className="d-inline">+800 taxes & Fees</text>
                   <a href="/booking"><button className="d-block btn btn-warning mx-auto w-50 p-1">Book this now</button></a> 
                </div>
                <div className="border rounded ms-2" style={{position:"relative",left:650,bottom:420,width:550,height:430}}>
                    ...
                    <div className="" style={{position:"relative",bottom:380,left:280}}>
                        <h4>Room with Breakfast</h4><br/>
                           ...
                           <h3 className="ms-3 d-inline text-success " style={{position:"relative", bottom:30}}>&#8377;8000</h3>
                           ...
                           <h3 className="ms-3 d-inline text-success" style={{position:"relative", bottom:30}}>&#8377;10000</h3>
