            ...
            <div className="room-content-flex">
                <div className="room-main-content">
                    <div className="room-images-grid">
                        <img src={'/assets/rooms/famroom2.jpg'} alt="Family Room main" className="room-img-main" />
                        <img src={'/assets/rooms/famroom1.jpg'} alt="Family Room view 2" />
                        <img src={'/assets/rooms/famroom2.jpg'} alt="Family Room view 3" />
                    </div>
                ...
                <div className="room-sidebar">
                    <div className="booking-card">
                        <h2>5 Standard Bed with Balcony</h2>
                        <div className="bed-info">Fits 10 Adults</div>
                        ...
                        <div className="price-section">
                            ...
                            <h3 className="price-value">&#8377;8000</h3>
                            <span className="price-taxes">+800 taxes & Fees</span>
                        </div>

                        <Link to="/booking" state={{ hotelName, location: hotelLocation, roomType: 'Family Room', price: 8000 }} className="btn-book-primary">
                            Book this now
                        </Link>
                    </div>
                    ...
                    <div className="room-types-card">
                        ...
                        <div className="room-type-option">
                            ...
                            <div className="room-type-action">
                                <div className="room-type-price">&#8377;8000</div>
                        ...
                        <div className="room-type-option">
                            ...
                            <div className="room-type-action">
                                <div className="room-type-price">&#8377;10000</div>
