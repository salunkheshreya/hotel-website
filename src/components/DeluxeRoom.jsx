            ...
            <div className="room-content-flex">
                <div className="room-main-content">
                    <div className="room-images-grid">
                        <img src={'/assets/rooms/deroom2.jpg'} alt="Deluxe Room main" className="room-img-main" />
                        <img src={'/assets/rooms/deroom1.jpg'} alt="Deluxe Room view 2" />
                        <img src={'/assets/rooms/deroom3.jpg'} alt="Deluxe Room view 3" />
                    </div>
                ...
                <div className="room-sidebar">
                    <div className="booking-card">
                        <h2>1 King Bed with Balcony</h2>
                        <div className="bed-info">Fits 3 Adults</div>
                        ...
                        <Link to="/booking" state={{ hotelName, location: hotelLocation, roomType: 'Deluxe Room', price: 5200 }} className="btn-book-primary">
                            Book this now
                        </Link>
                    </div>
