...
const DeluxeRoom = ()=>{
        ...
        return (
            <div style={{marginBottom:300,margin:0,padding:0,boxSizing:"border-box",height:1150,position:"relative",overflow:"hidden"}}> 
                <div className="mx-5">
                   <h1 style={{fontFamily:"Times New Roman",fontWeight:"bold"}}>Deluxe Room</h1>
                     ...
                     <div className="border rounded w-50 p-3" style={{height:950}}>
                        <div>
                           <img className="p-3 rounded-5" style={{position:"relative",bottom:20}} 
                            src={'/assets/rooms/deroom2.jpg'}
                            alt="room1" height={355} width={290} />
                           <img className=" rounded-5 d-inline" style={{position:"relative",bottom:-60,left:10}} height={150} width={250} src={'/assets/rooms/deroom1.jpg'} alt="room2"/>
                           <img className="rounded-5" style={{position:"relative",left:200,bottom:360,left:300}} height={150} width={250} src={'/assets/rooms/deroom3.jpg'} alt="room3"/>
                ...
                <div className="d-flex gap-2 ms-3" style={{position:"relative",bottom:200}}>
                    <button style={{fontSize:14}} className="btn btn-warning" onClick={handleClick}>Location & Surroundings</button><br></br>
                ...
                <div className="border rounded-3 p-3"style={{position:"relative",bottom:30,backgroundColor:"lightyellow"}}>
                    ...
                    <form className="form-group d-flex justify-content-evenly ">
                        <label htmlFor="ph" style={{position:'relative',bottom:20}}>Mobile No.</label>
                        <input type="text" className="form-control w-50 h-25" id="ph" placeholder="+91"/>
                       <button style={{position:'relative',bottom:8}} className="btn btn-warning mt-2"><Link to="/login">Login</Link></button>
                    </form>
                </div>
                </div>
                </div>
                ...
                <div className="border float-end me-4 rounded p-3" style={{position:"relative",bottom:950,right:28,width:550,fontFamily:"sans-serif,georgia"}} >
                    <h1 style={{fontFamily:'Sans-Serif Verdana',fontWeight:'bold'}}>1 King Bed with Balcony</h1>
                    <h3 className="p-2">Fits 3 Adults</h3>
                    ...
                    <h1 className=" d-inline-block text-primary ms-4 p-2">&#8377;5200</h1><text className="d-inline">+800 taxes & Fees</text>
                ...
                <div className="border rounded ms-2" style={{position:"relative",left:650,bottom:420,width:550,height:430}}>
                    ...
                    <div className="" style={{position:"relative",bottom:380,left:280}}>
                        <h4>Room with Breakfast</h4><br/>
                           ...
                           <h3 className="ms-3 d-inline text-success " style={{position:"relative", bottom:30}}>&#8377;5200</h3>
                           ...
                           <h3 className="ms-3 d-inline text-success" style={{position:"relative", bottom:30}}>&#8377;6000</h3>
