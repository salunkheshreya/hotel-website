...
const KidsRoom = ()=>{
        ...
        return (
            <div style={{marginBottom:300,margin:0,padding:0,boxSizing:"border-box",height:1150,position:"relative",overflow:"hidden"}}>
                <div className="mx-5">
                   <h1 style={{fontFamily:"Times New Roman",fontWeight:"bold"}}>Kids Room</h1>
                     ...
                     <div className="border rounded w-50 p-3" style={{height:950}}>
                        <div>
                           <img className="p-3 rounded-5" style={{position:"relative",bottom:20}} 
                            src={'/assets/rooms/kroom2.jpg'}
                            alt="room1" height={355} width={290} />
                           <img className=" rounded-5 d-inline" style={{position:"relative",bottom:-60,left:10}} height={150} width={250} src={'/assets/rooms/kroom1.jpg'} alt="room2"/>
                           <img className="rounded-5" style={{position:"relative",left:200,bottom:360,left:300}} height={150} width={250} src={'/assets/rooms/kroom3.jpg'} alt="room3"/>
                ...
                <div className="border rounded-3 p-3"style={{position:"relative",bottom:30,backgroundColor:"lightyellow"}}>
                    ...
                    <form className="form-group d-flex justify-content-evenly">
                        <label  style={{position:'relative',bottom:15}} htmlFor="ph">Mobile No.</label>
                ...
                <div className="border float-end me-4 rounded p-3" style={{position:"relative",bottom:950,right:28,width:550,fontFamily:"sans-serif,georgia"}} >
                    <h1 style={{fontFamily:'Sans-Serif Verdana',fontWeight:'bold'}}>2 Queen Bed with Balcony</h1>
                    <h3 className="p-2">Fits 4 Children</h3>
                    ...
                    <h1 className=" d-inline-block text-primary ms-4 p-2">&#8377;5200</h1><text className="d-inline">+600 taxes & Fees</text>
                       ...
                       <div className="card ms-3 d-inline-block" style={{width: 250,height:380}}>
                          <img style={{height:200}} src="/assets/rooms/room1.jpeg" class="card-img-top" alt="..."/>
                            <div className="card-body">
                             <h5 className="card-title">Kids Room</h5>
