            ...
            <div className="room-content-flex">
                <div className="room-main-content">
                    <div className="room-images-grid">
                        <img src={'/assets/rooms/preroom2.jpg'} alt="Semi-Deluxe Room main" className="room-img-main" />
                        <img src={'/assets/rooms/preroom1.jpg'} alt="Semi-Deluxe Room view 2" />
                        <img src={'/assets/rooms/preroom3.jpg'} alt="Semi-Deluxe Room view 3" />
                    </div>
                ...
                <div className="room-sidebar">
                    <div className="booking-card">
                        <h2>1 Queen Bed with Balcony</h2>
                        <div className="bed-info">Fits 2 Adults & 1 child</div>
                        ...
                        <div className="price-section">
                            ...
                            <h3 className="price-value">&#8377;4100</h3>
                            <span className="price-taxes">+800 taxes & Fees</span>
                        </div>

                        <Link to="/booking" state={{ hotelName, location: hotelLocation, roomType: 'Semi-Deluxe Room', price: 4100 }} className="btn-book-primary">
                            Book this now
                        </Link>
                    </div>
                    ...
                    <div className="room-types-card">
                        ...
                        <div className="room-type-option">
                            ...
                            <div className="room-type-action">
                                <div className="room-type-price">&#8377;4100</div>
                        ...
                        <div className="room-type-option">
                            ...
                            <div className="room-type-action">
                                <div className="room-type-price">&#8377;5000</div>
